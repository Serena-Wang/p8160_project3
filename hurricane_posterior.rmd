...
& exp(-\frac{400\gamma^\intercal\gamma}{2}) \\
=& exp(-\frac{1}{2}\sum_{i=1}^{H} \gamma^\intercal(X_i^\intercal\sigma^{-2}I_{n_i}X_i - 400\frac{1}{H}I_3)\gamma -2\gamma^\intercal(X_i\sigma^{-2}I_{n_i}Y_i-X_i^\intercal\sigma^{-2}I_{n_i}D_i\beta_i) + \\
...
Let $M = \sum_{i=1}^{H}X_i^\intercal\sigma^{-2}I_{n_i}X_i - 400I_3$ and $N = \sum_{i=1}^{H}(X_i\sigma^{-2}I_{n_i}Y_i-X_i^\intercal\sigma^{-2}I_{n_i}D_i\beta_i), \\$
