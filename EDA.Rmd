...
map +
  ...
  ggtitle(paste0("Plot 1: Atlantic Windstorm mean knot"))
```
...
hurricane %>% 
  ...
  scale_color_manual(name = "Speed",
                     values = c(" " = "#404080")) +
  labs(title = "Plot 2: Hurricane Frequency and Average Wind Speed by Month")
```
...
hurricane %>% 
  ...
  scale_color_manual(name = "Speed",
                     values = c(" " = "#404080")) +
  labs(title = "Plot 3: Hurricane Frequency and Average Wind Speed by Year",
       x = "Year")
```
...
hurricane %>% 
  ...
  labs(title = "Plot 4: Hurricane Wind Speed Boxplot by Nature",
       x = "Nature")
```
