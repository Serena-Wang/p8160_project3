...
Initially, we conducted MCMC sampling using the original Year data from 1950 to 2013. However, the resulting Year parameters did not converge. Consequently, we employed a scaled Year dataset obtained by subtracting 1949 from each Year value, which eventually led to the convergence of the Year parameters.
