...
In the end, we must also note that the data set only include hurricane observations from 1950 up to 2013. Our results might not be generalizable to predict wind speed of hurricanes beyond this time range especially due to global warming in recent years. 
